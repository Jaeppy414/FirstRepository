...
public class E07Random {
	...
	public static void main(String[] args) {
		...
		/*
		Random 클래스는 객체 생성시 전달되는 Sedd(씨앗)을 기반으로 난수를
		생성한다. 만약 동일한 Seed를 사용하면 항상 같은 패턴의 난수가
		생성되는데 이를 가짜난수(Pseudo-random number)라고 한다.
		 */
		System.out.println("# 가짜난수 : 같은 패턴의 난수만 생성됨"); //예를 들어 비행기 게임에서 항상 같은 자리에서 적 비행기가 소환되게 할 수 있음
		...
		/*
		씨드를 부여하려면 setSeed() 메서드를 사용한다. 이 때 현재시간을
