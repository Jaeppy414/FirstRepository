...
class Avengers {
	...
	/*
	Set계열의 컬렉션에 객체 입력시 중복 을제거하기 위해 hashCode(),
...
//			+ this.weapon.hashCode();
	...
	public boolean equals(Object obj) {
		...
		//각 멤버변수를 비교한다.
		if(this.heroName.equals(av.heroName) && this.name.equals(av.name) && this.weapon.equals(av.weapon)){
...
public class QuHashSet {
	...
	public static void main(String[] args) {
		...
		for(Avengers av : set) {
			if(searchName.equals(av.name) || searchName.equals(av.heroName) || searchName.equals(av.weapon)) {
