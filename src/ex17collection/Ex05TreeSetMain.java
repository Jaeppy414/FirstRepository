...
class MyString implements Comparable<MyString> {
	...
	//getlength() 멤버메서드 : 문자열의 길이를 반환
	public int getLength() {
		return str.length();
	}
	/*
	TreeSet<T>에 객체를 저장할 때 정렬을 위해 compareTo()메소드를
	오버라이딩한다.
	정렬의 기준은 단순하게 가나다와 같은 순서가 될 수도 있고, 문자열의
	길이에 따른 정렬도 될 수 있다.
