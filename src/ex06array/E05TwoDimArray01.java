...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		아래와 같이 2차원배열을 초기화하면 세로(행)3, 가로(열)4인
		...
		/*
		2차원 배열에서는 배열변수.length를 통해 전체 행의 크기를 확인할
		수 있다.
		 */
		...
		for(int i=0 ; i<arr.length ; i++){
			/*
			2차원배열에서 각 행의 크기를 알고 싶을 때는 배열명[인덱스]
			를 사용한다.
			 */
		...
		System.out.println("arr[0][3]= "+ arr[2][3]);//예외발생
		
		System.out.println("str3[][]="+ str3[0][0]);
	}
