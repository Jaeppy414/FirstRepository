...
public class E03MethodType02_2 {
	...
	/*
	Java에서 main()은 항상 public static void로 선언해야한다. 
	또한 static으로 선언된 메서드에서 호출되는 메서드는 
	항상 static으로 선언해야 한다. 단 public의 경우 현 
	상태에서는 있어도 없어도 별다른 차이가 없다.
	 */
	static String getHakjum() {
		...
		//평균값을 계산한다. 소수점의 결과를 위해 3.0으로 나눈다.
