...
public class E05PersonConstructorMain {
	...
	public static void main(String[] args) {
		...
		//기존에 생성된 person1을 초기화메서드를 통해 값을 변경한다.
		System.out.println("[멤버변수 초기화용 메소드 호출후");
		person1.initialize("홍길동", 20, "논현동");
		person1.showPersonInfo();
		
		/*
		객체생성시 초기화 메서드를 사용하면 객체생성과 초기화를 별도로
		진행해야 한다. 
		하지만 생성자를 사용하면 객체생성과 동시에 초기화를 진행할 수 있다.
		 */
		...
		PersonConstructor person4 = new PersonConstructor("이길동", 50, "가산동");
		person4.showPersonInfo();
		
		System.out.println("[ㅎㅇㅎㅇㅎㅇ]");
		PersonConstructor person5 = new PersonConstructor("이재필", 31, "중산동", 920414);
