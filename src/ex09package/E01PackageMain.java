...
패키지 선언부 : 현재 작성하는 클래스의 위치를 결정하기 위한
	선언으로 해당 클래스를 ex09package 패키지 하위에 묶어서
	생성하겠다는 의미이다.
 */
package ex09package;
/*
임포트 선언부 : 현재 작성중인 클래스에서 다른 패키지에 있는 클래스를
	가져다 쓰기 위한 선언으로, 사용할 클래스의 위치를 지장하는 것으로
	생각하면 된다.
	패키지명과 클래스명을 함께 기술한다.
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		ex09package 하위에 ex09package.study.util 패키지가 생성되지만
		...
		/*
		static으로 선언된 메서드는 new를 통해 객체생성없이
