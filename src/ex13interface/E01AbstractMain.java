...
-객체생성은 할 수 없으나 그 외 참조변수, 상속 등의 모든 기능을 사용할
수 있다.

추상메서드
-오버라이딩의 목적으로 제작된다.
-메서드의 실행부가 없으므로 중괄화{} 대신 ; 을 붙여 마무리한다.
 */
...
class AbsClassChild2 extends AbsClass2{
	...
	하는 것이므로 해당 자식쪽 클래스는 추상메서드를 포함하지 않는
	상태가 된다.
