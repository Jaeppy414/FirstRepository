...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		byte b1 = 65;
		short s1;
		//byte형이 short형보다 작은 자료형이므로 자동형변환된다.
		s1 = b1;
		System.out.printf("b1은 %d, s1은 %d%n", b1, s1);
		
		/*
		아래코드는 자동형변환이 아니다. CPU는 int보다 작은 자료형을
		int로 간주하고 연산을 진행한 후 결과도 int로 반환한다. 
		int형에 최적화되어있는 CPU의 특성이라 생각하면된다. 
		 */
		int num1 = b1 + s1;
...
//		char ch1 = b1; 
		...
		이하는 2자리까지만 표현하겠다는 의미
		 */
	 
		/*
		문자는 메모리에 저장시 아스키코드로 저장되므로 
		int형과의 연산을 진행한 후 문자로 표현하고 싶다면
		char형으로 강제형변환 후 출력하면 된다. 
		 */
		char ch3 = 'A', ch4;
		int num4 = 2; 
