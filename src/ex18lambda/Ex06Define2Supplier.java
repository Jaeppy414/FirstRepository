...
public class Ex06Define2Supplier {
	...
	public static void main(String[] args) {
		...
		//리스트 자체를 반복문 없이 출력할 수 있다. toSring()메서드가
		//이미 오버라이딩 되어있으므로 이처럼 출력할 수 있는 것이다.
	...
	/*
	매개변수로 전달된 람다식을 통해 난수를 생성한다. 이 때 cnt만큼 반복하게 
	되므로 결국 난수 10개를 생성하여 List컬렉션에 저장한 후 반환하고 있다.
	 */
