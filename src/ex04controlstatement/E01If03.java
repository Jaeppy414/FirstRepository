...
public class E01If03 {
	...
	public static void main(String[] args) {
		...
		else if(avg>=70) { //현재 평균값은 77.xx이므로 C학점 출력됨
		...
		구간을 정산 조건식으로 작성할 수 있다. 이때 논리연산자를 
		같이 사용한다. xx이상~xx미만과 같은 조건식이 만들어지게된다.
		 */
		...
		/*
		조건식의 순서를 정하기 애매한 경우에는 아래와 같이 점수의 
		구간을 정한 조건식으로 작성하면 된다. 이때 논리연산자를 같이 
		사용한다. xx이상~xx미만과 같은 조건식이 정해지게된다. 
		 */
